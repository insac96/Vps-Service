<template>
  <div>
    ...
    <div v-if="!cartStore.cart || cartStore.cart.length === 0">
      ...
      <UButton class="btn btn-primary ml-auto mr-auto mt-5 text-center text-primary justify-center flex align-center"
        icon="material-symbols:arrow-back-rounded" size="md" @click="router.push('/')">Quay lại</UButton>
    </div>
  </div>
</template>
